...
A seguir estão listados os requisitos do sistema.
...
Os requisitos não-funcionais referem-se a aspectos não-funcionais do sistema, como restrições nas quais o sistema deve operar ou propriedades emergentes do sistema.
...
Primeiramente o usuário informa o endereço de origem e destino à interface Cliente, repassando-os em seguida ao \emph{Web Service} para que o mesmo busque o caminho mínimo requisitado.
