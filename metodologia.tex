...
Como no desenvolvimento orientado a testes os testes são usualmente escritos antes do código do software, não existe código escrito que não seja necessário para passar um teste.
...
% TODO: escrever uma breve introdução da seção
Durante a codificação, diversas ferramentas mostraram-se necessárias.
% TODO: OH CRAP, faltou tempo nesse tomate
...
% TODO: escrever considerações finais da metodologia
