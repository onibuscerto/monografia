...
O seguinte projeto engloba e integra o uso de diversos conhecimentos adquiridos ao longo de um curso de engenharia de computação, principalmente na área de \emph{software}.
...
\begin{itemize}
	...
	\item \textbf{Desenvolvimento pra web}: o projeto como um todo consiste em uma aplicação web, sendo portanto utilizadas técnicas para desenvolvimento deste tipo de 	\emph{software}.
	...
	\item \textbf{Engenharia de \emph{software}}: uso de diversos conceitos envolvendo esta área, como técnicas de desenvolvimento e gerência de projeto, padrões de código, 		versionadores, estabelecimento de metas, revisão de código, entre outros.
\end{itemize}
% TODO: justificar pq q um engenheiro de computação deve saber desenvolver esse projeto

\section{Objetivos}

% Acho que fica melhor sem essa linha:
...
\begin{itemize}
	...
	\item Distribuir as tecnologias desenvolvidas sob a forma de \emph{software} livre, o que viabiliza futuras contribuições ao projeto e integrações a diversos outros sistemas.
\end{itemize}

\section{Apresentação do Documento}
Este documento encontra-se estruturado em 7 capítulos, sendo:
...
\begin{itemize}
	...
	\item Capítulo 3 - \textbf{ESPECIFICAÇÃO DO \emph{SOFTWARE}}: neste capítulo é apresentado o projeto do \emph{software}, contendo desde seus requisitos até a arquitetura do sistema idealizada.

	\item Capítulo 4 - \textbf{METODOLOGIA}: neste capítulo é apresentada a estratégia de desenvolvimento de \emph{software} utilizada neste projeto, bem como todas as ferramentas utilizadas neste processo. 

	\item Capítulo 5 - \textbf{DESENVOLVIMENTO DO \emph{SOFTWARE}}: neste capítulo é apresentado o desenvolvimento do sistema, contendo detalhes específicos de sua implementação.
	...
	\item Capítulo 7 - \textbf{CONCLUSÃO}: neste capítulo é feita uma discussão dos objetivos alcançados do projeto, a relação do mesmo com a profissão de Engenheiro de Computação e são apresentadas propostas de trabalhos futuros relacionados.
